...
var config = {
  ...
  uaa: {
	...
	serverUrl:'https://ae4de37f-6cd7-430b-98cb-88c83bf9fef8.predix-uaa.run.aws-usw02-pr.ice.predix.io',
    defaultClientRoute: '/about',
    //base64ClientCredential: 'cHJlZGl4LXNlZWQ6TTBhVzdrTmZRRndyTTZ3ZHJpV2h3bVc2ck1HQ045Q0x1cnI5VnI3elc0cz0='
	base64ClientCredential:'ZGlnaXRhbFR3aW5XZWJBcHA6ZGlnaXRhbFR3aW5XZWJBcHBwQHNzd0BkCg=='
  },
  /**
  ...
  proxy: {
    '/api/view-service': {
      url: 'https://predix-views.run.asv-pr.ice.predix.io/api$1',
      instanceId: 'GE_DigitalTwin_Current_VIEWS_Service',
