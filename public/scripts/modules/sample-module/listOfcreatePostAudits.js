...
define(
    ...
    function(angular, controllers) {
        ...
        controllers.controller('listOfcreatePostAuditsCtrl', ['$state', '$timeout', '$http', '$log', 'PredixAssetService', '$rootScope', '$scope', 'commonServices', function($state, $timeout, $http, $log, PredixAssetService, $rootScope, $scope, commonServices) {
            var urlPathArr = [];
