...
define(
    ...
    function(angular, controllers) {
        ...
        controllers.controller('listOfcrateInstallDrawingCtrl', ['$state', '$timeout', '$http', '$log', 'PredixAssetService', '$rootScope', '$scope', 'commonServices', function($state, $timeout, $http, $log, PredixAssetService, $rootScope, $scope, commonServices) {
      ...
      var ssoObj = window.localStorage.getItem("SSO_ID");
        const ssoPrivilegeData = {
            ...
            //     $http.get(getSiteListSurveyor).success(function(data) {
                ...
                commonServices.getSiteListForPM(ssoObj, "Install Drawing,Install Drawing","InProgress,Completed").then(function(data) {
                   ...
                   // data = data.concat(pmList);
                    ...
                    angular.forEach(data, function(value, key) {
                        ...
                        console.log(siteId);
                        pmviewData[key].ticketId = "<a href=/createdrawingdetails/" + value.ticketId + "/" + siteId + "/" + value.ticketSiteDetailsId + " ui-sref=createdrawingdetails({ticketId:'" + value.ticketId + "/" + value.siteId + "/" + value.ticketSiteDetailsId + "'}) 'style='text-decoration: none'>" + value.ticketId + "</a>";
