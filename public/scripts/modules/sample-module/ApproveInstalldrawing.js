...
define(
    ...
    function(angular, controllers) {
        ...
        controllers.controller('ApproveInstalldrawingCtrl', ['$state', '$timeout', '$http', '$log', 'PredixAssetService', '$rootScope', '$scope', 'commonServices', function($state, $timeout, $http, $log, PredixAssetService, $rootScope, $scope, commonServices) {
            var urlPathArr = [];
      ...
      var ssoObj = window.localStorage.getItem("SSO_ID");
        const ssoPrivilegeData = {
            ...
            privilegeAccess();
            var ssoObj = window.localStorage.getItem("SSO_ID");
            //var getSiteList = commonServices.getadminServiceURL() + "/sitelist?assignedTo=" + ssoObj + "&stageName=PM%20Install%20Drawing%20Approval&status=InProgress";
            var getSiteName = "https://predix-asset.run.aws-usw02-pr.ice.predix.io/site?filter=";
            // var getSiteListSurveyor =commonServices.getadminServiceURL()+"/sitelist?assignedTo=1&stageName=PM%20Install%20Drawing%20Approval&status=Completed";
           // var getSiteListSurveyor = commonServices.getadminServiceURL() + "/sitelist?assignedTo=" + ssoObj + "&stageName=PM%20Install%20Drawing%20Approval&status=Completed";
            // LOCAL URL
