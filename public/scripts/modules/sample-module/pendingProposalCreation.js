...
define(
    ...
    function(angular, controllers) {
        ...
        controllers.controller('pendingProposalCreationCtrl', ['$state', '$timeout', '$http', '$log', 'PredixAssetService', '$rootScope', '$scope', 'commonServices', function($state, $timeout, $http, $log, PredixAssetService, $rootScope, $scope, commonServices) {
            ...
            //     $http.get(getSiteListSurveyor).success(function(data) {
                ...
                commonServices.getSiteListForPM(ssoObj, "Proposal,Proposal","InProgress,Completed").then(function(data) {
                    ...
                    angular.forEach(data, function(value, key) {
                        ...
                        pmviewData[key].ticketId = "<a href=/createproposal/" + value.ticketId + "/" + value.siteId + "/" + value.ticketSiteDetailsId + " ui-sref=createproposal({ticketId:'" + value.ticketId + "/" + value.siteId + "/" + value.ticketSiteDetailsId + "'}) 'style='text-decoration: none'>" + value.ticketId + "</a>";
