...
function() {
                        ...
                        post: function(a, b, c, f) {
                            ...
                            b.addClass("ui-grid-render-container-" + a.containerId), d.on.mousewheel(b, function(a) {
                                ...
                                if (0 !== a.deltaY) {
                                    ...
                                    var f = (m + c) / k.getVerticalScrollLength();
                                    0 > f ? f = 0 : f > 1 && (f = 1), b.y = {
                                        percentage: f,
                                        pixels: c
                                    }
                                ...
                                if (0 !== a.deltaX) {
                                    ...
                                    var h = (n + g) / (l.getCanvasWidth() - l.getViewportWidth());
                                    0 > h ? h = 0 : h > 1 && (h = 1), b.x = {
                                        percentage: h,
                                        pixels: g
                                    }
                    ...
                    return {
                        post: function(a, b, c, d) {
                            ...
                            function g() {
                                var c = "";
                                if ("left" === a.side || "right" === a.side) {
                                    i = f(), b.attr("style", null);
                                    var d = h.renderContainers.body.getViewportHeight();
                                    c += ".grid" + h.id + " .ui-grid-pinned-container-" + a.side + ", .grid" + h.id + " .ui-grid-pinned-container-" + a.side + " .ui-grid-render-container-" + a.side + " .ui-grid-viewport { width: " + i + "px; height: " + d + "px; } "
                                }
                                return c
                            }
                            var h = d.grid,
    ...
    function() {
        angular.module("ui.grid").factory("GridColumn", ["gridUtil", "uiGridConstants", "i18nService", function(a, b, c) {
            ...
            return d.prototype.setPropertyOrDefault = function(a, b, c) {
                ...
                if (a.isNullOrUndefined(e.width) || !angular.isNumber(e.width))
                    if (a.isNullOrUndefined(b.width)) e.width = "*";
                    else if (angular.isNumber(b.width)) e.width = b.width;
                else if (a.endsWith(b.width, "%")) {
                    var g = b.width.replace(/%/g, ""),
                        h = parseInt(g, 10);
                    if (isNaN(h)) throw new Error(f);
                    e.width = b.width
                } else if (b.width.match(/^(\d+)$/)) e.width = parseInt(b.width.match(/^(\d+)$/)[1], 10);
                else {
                ...
                b.filter ? i.push(b.filter) : b.filters ? i = b.filters : i.push({}), c ? (e.setPropertyOrDefault(b, "filter"), e.setPropertyOrDefault(b, "filters", i)) : e.filters.length === i.length && e.filters.forEach(function(a, b) {
                    "undefined" != typeof i[b].placeholder && (a.placeholder = i[b].placeholder),
                        "undefined" != typeof i[b].flags && (a.flags = i[b].flags), "undefined" != typeof i[b].type && (a.type = i[b].type), "undefined" != typeof i[b].selectOptions && (a.selectOptions = i[b].selectOptions)
    ...
    function() {
        angular.module("ui.grid").factory("ScrollEvent", ["gridUtil", function(a) {
            function b(b, c, d, e) {
                ...
                f.grid = b, f.source = e, f.withDelay = !0, f.sourceRowContainer = c, f.sourceColContainer = d, f.newScrollLeft = null, f.newScrollTop = null, f.x = null, f.y = null, f.fireThrottledScrollingEvent = a.throttle(function(a) {
            ...
            return b.prototype.getNewScrollLeft = function(b, c) {
                ...
                return this.y && 0 === this.y.percentage && 0 === a
            }, b.prototype.atBottom = function(a) {
                return this.y && 1 === this.y.percentage && a > 0
            }, b.prototype.atLeft = function(a) {
                return this.x && 0 === this.x.percentage && 0 === a
            }, b.prototype.atRight = function(a) {
                return this.x && 1 === this.x.percentage && a > 0
            }, b.Sources = {
                    ...
                    var g = [],
                        h = function(b, f, h, i, j) {
                            c[b] ? d[f] = c[b] : d[f] = h, g.push(a.getTemplate(d[f]).then(function(a) {
                                ...
                                j && d[j] === !1 ? a = a.replace(e.TOOLTIP, "") : j && d[j] && (a = a.replace(e.TOOLTIP, 'title="{{' + c + ' CUSTOM_FILTERS }}"')), i ? d[b] = a.replace(e.CUSTOM_FILTERS, d[i] ? "|" + d[i] : "") : d[b] = a
                            }, function(a) {
    ...
    function() {
        ...
        b.service("rowSearcher", ["gridUtil", "uiGridConstants", function(b, c) {
            ...
            return e.getTerm = function(a) {
                ...
                var f = typeof e.condition,
                    g = e.term,
                    h = a.getCellValue(b, d);
                ...
                if ("number" == typeof h && "string" == typeof g) {
                        ...
                        post: function(a, b, c, d) {
                            ...
                            if (h.grid.api.cellNav) {
                                var j = i.containerId,
                                    k = h.grid;
                                if ("body" === j) {
                                    e.decorateRenderContainers(k);
                                    var l = f('<div class="ui-grid-focuser" tabindex="0"></div>')(a);
                                    b.append(l), h.focus = function() {
                                        l[0].focus(), l.on("focus", function(a) {
                                            a.uiGridTargetRenderContainerId = j;
                                            var b = h.grid.api.cellNav.getFocusedCell();
                                            null === b && (b = h.grid.renderContainers[j].cellNav.getNextRowCol(g.direction.DOWN, null, null), b.row && b.col && h.cellNav.broadcastCellNav(b))
                                        })
                                    }, l.on("keydown", function(a) {
                                        a.uiGridTargetRenderContainerId = j;
                                        var b = h.grid.api.cellNav.getFocusedCell(),
                                            c = h.cellNav.handleKeyDown(a);
                                        null === c && h.grid.api.cellNav.raise.viewPortKeyDown(a, b)
                                    })
                                }
                            }
                        }
    ...
    function() {
        ...
        a.constant("uiGridEditConstants", {
            ...
            return {
                ...
                link: function(b, k, l, m) {
                    function n() {
                        k.on("dblclick", t), k.on("touchstart", o), m && m.grid.api.cellNav && (D = m.grid.api.cellNav.on.navigate(b, function(a, d) {
                    ...
                    function o(a) {
                        "undefined" != typeof a.originalEvent && void 0 !== a.originalEvent && (a = a.originalEvent), k.on("touchend", p), A = c(function() {}, j), A.then(function() {
                            setTimeout(t, 0), k.off("touchend", p)
                        })
                    }

                    function p(a) {
                        c.cancel(A), k.off("touchend", p)
                    }

                    function q() {
                        k.off("dblclick", t), k.off("keydown", r), k.off("touchstart", o), D()
                    }
                    ...
                    function t(c) {
                        if (!C && s(b.col, b.row)) {
                            z = g(b.row.getQualifiedColField(b.col)), y = z(b), x = b.col.editableCellTemplate, x = b.col.colDef.editModelField ? x.replace(d.MODEL_COL_FIELD, f.preEval("row.entity." + b.col.colDef.editModelField)) : x.replace(d.MODEL_COL_FIELD, b.row.getQualifiedColField(b.col)), x = x.replace(d.COL_FIELD, "grid.getCellValue(row, col)");
                            var h = b.col.colDef.editDropdownFilter ? "|" + b.col.colDef.editDropdownFilter : "";
                            x = x.replace(d.CUSTOM_FILTERS, h);
                            var j = "text";
                            ...
                            var n = b.col.grid.api.core.on.scrollBegin(b, function() {
                                    u(!0), b.grid.api.edit.raise.afterCellEdit(b.row.entity, b.col.colDef, z(b), y), n(), o(), p()
                                }),
                                o = b.$on(e.events.END_CELL_EDIT, function(a, c) {
                                    u(c), b.grid.api.edit.raise.afterCellEdit(b.row.entity, b.col.colDef, z(b), y), o(), n(), p()
                                }),
                    ...
                    function u(a) {
                        if (b.grid.disableScrolling = !1, C) {
                            var c = angular.element(k.children()[0]);
                            B.$destroy(), angular.element(k.children()[1]).remove(), c.removeClass("ui-grid-cell-contents-hidden"), C = !1, n(), b.grid.api.core.notifyDataChange(d.dataChange.EDIT)
                        }
                    }

                    function v() {
                        b.grid.disableScrolling = !1, C && (z.assign(b, y), b.$apply(), b.grid.api.edit.raise.cancelCellEdit(b.row.entity, b.col.colDef), u(!0))
                    }
                    ...
                    if (b.col.colDef.enableCellEdit) {
                        ...
                        m && m.grid.api.cellNav && m.grid.api.cellNav.on.viewPortKeyDown(b, function(a, c) {
                            null !== c && (c.row !== b.row || c.col !== b.col || b.col.colDef.enableCellEditOnFocus || (r(a), m.grid.api.core.scrollToIfNecessary(c.row, c.col)))
                        });
                        var E = function() {
        ...
        }]), a.directive("uiGridEditor", ["gridUtil", "uiGridConstants", "uiGridEditConstants", "$timeout", function(a, b, c, d) {
            return {
                scope: !0,
                require: ["?^uiGrid", "?^uiGridRenderContainer"],
                compile: function() {
                    return {
                        ...
                        post: function(a, e, f, g) {
                            var h, i;
                            g[0] && (h = g[0]), g[1] && (i = g[1]), a.$on(c.events.BEGIN_CELL_EDIT, function() {
                                e[0].focus(), e[0].select(), e.on("blur", function(b) {
                                    a.stopEdit(b)
                                })
                                ...
                                "checkbox" !== e[0].type && (a.deepEdit = !0, d(function() {
                                    a.grid.disableScrolling = !0
                                }))
                            }), e.on("keydown", function(d) {
                                switch (d.keyCode) {
                                    case b.keymap.ESC:
                                ...
                                if (!a.deepEdit || d.keyCode !== b.keymap.LEFT && d.keyCode !== b.keymap.RIGHT && d.keyCode !== b.keymap.UP && d.keyCode !== b.keymap.DOWN)
                                    if (h && h.grid.api.cellNav) d.uiGridTargetRenderContainerId = i.containerId, null !== h.cellNav.handleKeyDown(d) && a.stopEdit(d);
        ...
        a.constant("uiGridExporterConstants", {
            ...
            var g = {
                ...
                downloadPDF: function(a, b) {
                    ...
                    if (f.getBuffer(function(a) {
                            e = new Blob([a])
                        }), c && 10 > c) {
                        var g = d.createElement("iframe");
                        return document.body.appendChild(g), g.contentWindow.document.open("text/html", "replace"), g.contentWindow.document.write(e), g.contentWindow.document.close(), g.contentWindow.focus(), g.contentWindow.document.execCommand("SaveAs", !0, a), document.body.removeChild(g), !0
                    }
            ...
            var j = {
                ...
                groupColumn: function(a, c) {
                    ...
                    c.grouping.groupPriority = d.grouping.length, c.sort ? ("undefined" == typeof c.sort.direction || null === c.sort.direction) && (c.sort.direction = h.ASC) : c.sort = {
                        ...
                        source: "grouping"
                    }, c.treeAggregationFn = i.nativeAggregations()[b.aggregation.COUNT].aggregationFn, c.treeAggregationFinalizerFn = j.groupedFinalizerFn, a.queueGridRefresh()
                },
                ungroupColumn: function(a, b) {
                    "undefined" != typeof b.grouping && (delete b.grouping.groupPriority, delete b.treeAggregation, delete b.customTreeAggregationFinalizer, j.tidyPriorities(a), a.queueGridRefresh())
                },
                aggregateColumn: function(a, b, c) {
                    ...
                    }, b.treeAggregationFn = d.aggregationFn, b.treeAggregationFinalizerFn = d.finalizerFn, a.queueGridRefresh()
                },
            ...
            var g = {
                ...
                restoreColumns: function(a, b) {
                    b.forEach(function(b, c) {
                        ...
                        if (d && !a.isRowHeaderColumn(d)) {
                            !a.options.saveVisible || d.visible === b.visible && d.colDef.visible === b.visible || (d.visible = b.visible, d.colDef.visible = b.visible, a.api.core.raise.columnVisibilityChanged(d)), a.options.saveWidths && (d.width = b.width), !a.options.saveSort || angular.equals(d.sort, b.sort) || void 0 === d.sort && angular.isEmpty(b.sort) || (d.sort = angular.copy(b.sort), a.api.core.raise.sortChanged()), a.options.saveFilter && !angular.equals(d.filters, b.filters) && (b.filters.forEach(function(a, b) {
                                angular.extend(d.filters[b], a), ("undefined" == typeof a.term || null === a.term) && delete d.filters[b].term
                            }), a.api.core.raise.filterChanged()), a.api.pinning && a.options.savePinning && d.renderContainer !== b.pinned && a.api.pinning.pinColumn(d, b.pinned);
                            var e = a.getOnlyDataColumns().indexOf(d);
                            if (-1 !== e && a.options.saveOrder && e !== c) {
                                var f = a.columns.splice(e + a.rowHeaderColumns.length, 1)[0];
                                a.columns.splice(c + a.rowHeaderColumns.length, 0, f)
                            }
                        }
                    })
                },
        ...
        a.constant("uiGridTreeBaseConstants", {
            ...
            var i = {
                ...
                getAggregations: function(a) {
                    var b = [];
                    return a.columns.forEach(function(a) {
                        "undefined" != typeof a.treeAggregationFn && b.push(i.buildAggregationObject(a))
                    }), b
                },
                    ...
                    0 !== c.length && c.forEach(function(c) {
                        c.treeNode.aggregations && c.treeNode.aggregations.forEach(function(c) {
                            var d = a.getCellValue(b, c.col),
                                e = Number(d);
                            c.col.treeAggregationFn(c, d, e, b)
                        })
                    })
                },
